...
const cards = [
  {
    match: "Aaliyah",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt8nCpIn3rmM3T93geTmz8D0FhfeyrkFS0ts-nS6aXrMOpMq2a"
  },
  {
    match: "Aerin",
    src: "https://i.redd.it/93iqbgragztz.jpg"
  },
  {
    match: "Tyra",
    src:
      "https://i.pinimg.com/originals/88/36/94/8836940c1f8dd479a4c7319ecc647019.jpg"
  },
  {
    match: "SlickWoods",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFEd7RN2-JevY9Ns9V8n3J1tLSgCLwL4d7BjpiopIFPaGCuCIh"
  },
  {
    match: "Rihanna",
    src:
      "https://vg-images.condecdn.net/image/PmBdde3X1VN/crop/405/f/unknown_bb.jpg"
  },
  {
    match: "Left-Eye",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn4eBmyOmDbjUOUrcwN_Hu2JFbxMoAdPjsON4N5NX_X7CWnYa0"
  },
  {
    match: "Kehlani",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfmAZzBE4F-DlJ4c8_-3Wf73vY3ZjQLBw8RkOalgQ5Zi26B7An"
  },
  {
    match: "Janet",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuGKzuJA2GEDN3wBTThmutdLLdQPVOXAflU-Z7T4TF8oJM_2kWWg"
  },
  {
    match: "TLC",
    src:
...
function checkForMatch() {
  ...
  if (selectedCards[0].card.match === selectedCards[1].card.match) {
    ...
    // #5
    status.textContent = "Sucks For You";
  ...
  return shuffle(dupCards).forEach((card, idx) => {
    ...
    setTimeout(() => {
      imgFront.setAttribute(
        "src",
        // #3
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmBS6QSR2V8AXgASBmITuc3pnjJS9aHlVL0BA9kw4v5-wrw4Q7"
      );
