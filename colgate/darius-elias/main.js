...
const cards = [
  {
    match: "laviathan",
    src:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_-bid35nO2Se015IHTmoUOsXtFGRCkWuoiX4ezGPnm0_PvWZu"
  },
  {
    match: "rex ",
    src:
      "https://www.eclypsia.com/content/Dossier%20R%C3%A9dacteurs/D4yLess/Fortnite/Skins/fortnite-outfit-rex-400x418.jpg"
  },
  {
    match: "moisty merman",
    src:
      "https://progameguides.com/wp-content/uploads/2017/12/fortnite-outfit-moisty-merman-full-400x418.jpg"
  },
  {
    match: "dark voyager",
    src:
      "https://www.eclypsia.com/content/Dossier%20R%C3%A9dacteurs/D4yLess/Fortnite/Skins/fortnite-outfit-dark-voyager-hd-400x418.jpg"
  },
  {
    match: "havoc",
    src:
      "https://www.breakflip.com/uploads/AAA/Epic%20Games/Fortnite/Skins/fortnite-outfit-havoc-400x418.jpg"
  },
  {
    match: "battle hound",
    src:
      "https://www.breakflip.com/uploads/AAA/Epic%20Games/Fortnite/Skins/fortnite-outfit-battle-hound-400x418.jpg"
  },
  {
    match: "monkey guy",
    src:
      "https://www.breakflip.com/uploads/AAA/Epic%20Games/Fortnite/Skins/fortnite-outfit-wukong-400x418.jpg"
  },
  {
    match: "crack shot",
    src:
...
function checkForMatch() {
  ...
  if (selectedCards[0].card.match === selectedCards[1].card.match) {
    ...
    // #5
    status.textContent = "really how you not see that ";
  ...
  return shuffle(dupCards).forEach((card, idx) => {
    ...
    setTimeout(() => {
      imgFront.setAttribute(
        "src",
        // #3
        "https://media1.tenor.com/images/4e855f4fbd769e6df43fafb55321c6b5/tenor.gif?itemid=11895048"
      );
