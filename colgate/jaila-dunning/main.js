...
const cards = [
  {
    match: "lv sandals",
    src: "https://luxrack.com/images/items/lv_sandals.jpg"
  },
  {
    match: "Jordans",
    src:
      "https://image-cdn.hypb.st/https%3A%2F%2Fhypebeast.com%2Fimage%2F2018%2F06%2Foff-white-air-jordan-1-unc-june-19-2018-release-1.jpg?q=75&w=1000&cbr=1&fit=max"
  },
  {
    match: "Vapormax",
    src:
      "https://www.flightclub.com/media/catalog/product/cache/1/image/1600x1140/9df78eab33525d08d6e5fb8d27136e95/8/0/803149_01.jpg"
  },
  {
...
// #3
let colors = ["#e6f2ff", "#ff8080", "#ff5050", "#cc0066", "#d9b3ff", "#66ffff"];
...
function checkForMatch() {
  ...
  if (selectedCards[0].card.match === selectedCards[1].card.match) {
    ...
    // #3
    status.textContent = "awesome! keep going";
    ...
    // #5
    status.textContent = "Are you dumb ? #confused";
  ...
  return shuffle(dupCards).forEach((card, idx) => {
    ...
    setTimeout(() => {
      imgFront.setAttribute(
        "src",
        // #3
        "https://www.billboard.com/files/styles/article_main_image/public/media/6ix9ine-Nicki-Minaj-fefe-2018-billboard-1548.jpg"
      );
